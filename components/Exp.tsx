...
export default function Exp() {
  return (
    <section className="min-h-screen w-screen h-auto relative bg-background"><h1 className="text-4xl font-bold text-primary flex items-center justify-center mt-8">Experience / Education</h1>
